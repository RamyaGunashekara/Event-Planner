...
function getDetails(){
                ...
                var query = 'SELECT * FROM "EVENT_PLANNER"."ROOM_BOOKING" where STATUS = ? ORDER BY STATUS';
				...
				while(rs.next()){
				    ...
				    object.startTime = rs.getString(4);
				    object.endTime = rs.getString(5);
				    object.startDate = rs.getString(6);
				    object.endDate = rs.getString(7);
